...
class ViewModelTest : AppCompatActivity() {
    ...
    private lateinit var androidUserViewMdoel: AndroidUserViewMdoel
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //안드로이드 ViewModel은 그냥 ViewModel과 다르게 ViewModelProvider.AndroidViewModelFactory 필
        androidUserViewMdoel=ViewModelProvider(this,ViewModelProvider.AndroidViewModelFactory(application)).get(AndroidUserViewMdoel::class.java)

        binding.user=androidUserViewMdoel //바인딩
        ...
        */
        ...
        androidUserViewMdoel.height.observe(this, Observer {
            binding.textViewHeight.text=it.toString()
        })
